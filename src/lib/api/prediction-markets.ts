...
// =============================================================================
// MOCK DATA FOR DEMO (Use when APIs are unavailable)
// =============================================================================
...
export const mockPredictionMarkets: PredictionMarket[] = [
  ...
  },
  {
    id: 'pm-3',
    platform: 'polymarket',
    question: 'Bitcoin above $150k by June 2025?',
    category: 'crypto',
    yesPrice: 28.5,
    noPrice: 71.5,
    spread: 2.1,
  ...
  },
  {
    id: 'pm-4',
    platform: 'kalshi',
    question: 'Fed cuts rates in January 2025?',
    category: 'economics',
    yesPrice: 8.5,
    noPrice: 91.5,
    spread: 1.5,
  ...
  },
  {
    id: 'pm-6',
    platform: 'kalshi',
    question: 'US GDP growth above 3% Q1 2025?',
    category: 'economics',
    yesPrice: 42.0,
    noPrice: 58.0,
    spread: 2.5,
  ...
  },
  {
    id: 'pm-7',
    platform: 'polymarket',
    question: 'Eagles win Super Bowl LIX?',
    category: 'sports',
    yesPrice: 28.8,
    noPrice: 71.2,
    spread: 0.9,
  ...
  },
  {
    id: 'pm-9',
    platform: 'kalshi',
    question: 'Category 5 hurricane hits US in 2025?',
    category: 'weather',
    yesPrice: 38.5,
    noPrice: 61.5,
    spread: 2.0,
    ...
    isActive: true,
    isHot: false,
    slug: 'cat5-hurricane-2025',
    outcomes: ['Yes', 'No'],
    lastTradePrice: 0.385,
    bestBid: 0.38,
    bestAsk: 0.40,
  },
  {
    id: 'pm-10',
    platform: 'polymarket',
    question: 'OpenAI releases GPT-5 by June 2025?',
    category: 'tech',
    yesPrice: 52.3,
    noPrice: 47.7,
    spread: 1.8,
  ...
  },
  {
    id: 'pm-12',
    platform: 'polymarket',
    question: 'Oscars Best Picture - Anora wins?',
    category: 'entertainment',
    yesPrice: 45.2,
    noPrice: 54.8,
    spread: 1.5,
    ...
    slug: 'oscars-anora',
    outcomes: ['Yes', 'No'],
    lastTradePrice: 0.452,
    bestBid: 0.445,
    bestAsk: 0.460,
  }
]

// Get mock data with optional category filter
export function getMockMarkets(category?: MarketCategory): PredictionMarket[] {
  if (!category || category === 'all') return mockPredictionMarkets
  return mockPredictionMarkets.filter(m => m.category === category)
}
