...
import { TrendingUp, Target, ChevronDown, Zap, Users, BarChart3, Calendar, Cloud, Wind } from 'lucide-react'
...
// MLB-specific: Starter and venue context
  ...
  if (error || !game) {
    return (
      <ErrorDisplay
        ...
        message="This MLB game couldn't be found. It may have been rescheduled or cancelled."
        backLink="/mlb/matchups"
        backText="Back to MLB matchups"
        showRetry={false}
      />
    )
  }
    ...
    >
      <MatchupLayout.Grid>
        <MatchupLayout.MainContent>
            ...
            <div className="bg-[#0c0c14] rounded-xl border border-white/10 p-4">
              ...
              <div className="grid grid-cols-4 gap-2">
                <div className="text-center p-2 bg-[#16161e] rounded-lg">
                  ...
                  <div className="text-[10px] text-gray-500">{game.homeTeam.abbreviation} RL</div>
                </div>
                <div className="text-center p-2 bg-[#16161e] rounded-lg">
                  <div className="text-lg font-bold text-blue-400">{h2h.awayATSRecord}</div>
                  <div className="text-[10px] text-gray-500">{game.awayTeam.abbreviation} RL</div>
                </div>
                <div className="text-center p-2 bg-[#16161e] rounded-lg">
                ...
                <div className="text-center p-2 bg-[#16161e] rounded-lg">
                  ...
                  <div className="text-[10px] text-gray-500">AVG RUNS</div>
                </div>
              </div>
            </div>
          )}
          ...
          {trends && trends.matched > 0 && trends.spreadTrends && (
            <div className="bg-[#0c0c14] rounded-xl border border-white/10 p-4">
              ...
              <Link href="/trends?sport=mlb" className="text-xs text-orange-400 hover:underline mt-2 inline-block">View all →</Link>
            </div>
          )}
        ...
        <MatchupLayout.Sidebar>
          ...
          <div className="space-y-2">
            <Link href="/trends?sport=mlb" className="flex items-center justify-between p-3 bg-[#0c0c14] rounded-xl border border-white/10 hover:border-orange-500/30 transition-all group">
              <div className="flex items-center gap-2"><TrendingUp className="w-4 h-4 text-orange-500" /><span className="text-sm text-white group-hover:text-orange-400">All MLB Trends</span></div>
