...
const mockPicks: Pick[] = [
  {
    ...
    game: { id: '1', homeTeam: 'Kansas City Chiefs', awayTeam: 'Buffalo Bills', gameTime: '2025-01-05T20:00:00Z', status: 'scheduled', score: null },
    sport: 'nfl',
    pickType: 'spread',
    selection: 'Chiefs -3',
    odds: -110,
    units: 2,
    confidence: 'high',
    analysis: 'Chiefs have won 8 of last 10 at home. Mahomes is 15-3 ATS as a home favorite.',
    result: 'pending',
  ...
  },
  {
    ...
    game: { id: '2', homeTeam: 'Boston Celtics', awayTeam: 'LA Lakers', gameTime: '2025-01-04T19:30:00Z', status: 'final', score: '118-102' },
    sport: 'nba',
    pickType: 'total',
    ...
    units: 1.5,
    confidence: 'medium',
    analysis: 'Both teams averaging 115+ PPG in last 5 games.',
    result: 'won',
