...
const STATIC_ROUTES = [
  ...
  { path: '/nfl/players', name: 'NFL Players', critical: true, category: 'sports' },
  { path: '/nfl/rankings', name: 'NFL Rankings', critical: false, category: 'sports' },
  ...
  { path: '/nhl/skaters', name: 'NHL Skaters', critical: false, category: 'sports' },
  { path: '/nhl/goalies', name: 'NHL Goalies', critical: false, category: 'sports' },
  { path: '/nhl/rankings', name: 'NHL Rankings', critical: false, category: 'sports' },
  ...
  { path: '/mlb/players', name: 'MLB Players', critical: true, category: 'sports' },
  { path: '/mlb/rankings', name: 'MLB Rankings', critical: false, category: 'sports' },
